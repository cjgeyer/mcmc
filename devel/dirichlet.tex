...
The R package \texttt{hitandrun} also does the uniform distribution on a
...
random-walk sampler and simulates any distribution specified by a user
...
Using ``independence'' updates \citep[Section~2.3.3]{tierney} does this.
